    ...
    <div className="flex h-screen bg-background text-foreground">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between p-4 bg-card border-b border-border md:hidden">
          <Link href="/dashboard"><h1 className="text-2xl font-bold text-foreground">Noted</h1></Link>
          <button onClick={() => setIsSidebarOpen(true)} className="p-2 text-foreground" aria-label="Open menu">
            <MenuIcon />
          </button>
        </header>
